...
4. [x] Scan open multiple ports in the domains (scan-port-domains)
5. [x] Scan open multiple ports in the public IPs (scan-public-ips)
...
Export users list of Iam in AWS
